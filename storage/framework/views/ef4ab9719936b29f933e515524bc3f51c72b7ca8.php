...
<li filter-name="<?php echo e($filter->name); ?>"
    ...
    <div class="dropdown-menu p-0">
      <div class="form-group backpack-filter mb-0">
			<select id="filter_<?php echo e($filter->key); ?>" name="filter_<?php echo e($filter->key); ?>" data-filter-key="<?php echo e($filter->key); ?>" data-filter-name="<?php echo e($filter->name); ?>" class="form-control input-sm select2" data-filter-type="select2_multiple" placeholder="<?php echo e($filter->placeholder); ?>" multiple>
...
<?php /**PATH E:\Programs\OpenServer\OSPanel\domains\storeclothing\vendor\backpack\crud\src\resources\views\crud/filters/select2_multiple.blade.php ENDPATH**/ ?>