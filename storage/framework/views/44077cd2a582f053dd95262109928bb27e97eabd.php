...
<?php $__currentLoopData = Arr::where($column['wrapper'],function($value, $key) { return $key != 'element'; }); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php echo e($element); ?>="<?php echo e($value); ?>"
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
><?php /**PATH E:\Programs\OpenServer\OSPanel\domains\storeclothing\vendor\backpack\crud\src\resources\views\crud/columns/inc/wrapper_start.blade.php ENDPATH**/ ?>