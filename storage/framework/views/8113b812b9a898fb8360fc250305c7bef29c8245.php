...
<?php echo $__env->make('crud::fields.inc.wrapper_start', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="btn-group">
        <div class="btn btn-light btn-sm btn-file">
            <?php echo e(trans('backpack::crud.choose_file')); ?> <input type="file" accept="image/*" data-handle="uploadImage"  <?php echo $__env->make('crud::fields.inc.attributes', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>>
            <input type="hidden" data-handle="hiddenImage" name="<?php echo e($field['name']); ?>" value="<?php echo e($value); ?>">
        </div>
        <?php if(isset($field['crop']) && $field['crop']): ?>
...
<?php if($crud->fieldTypeNotLoaded($field)): ?>
    ...
    <?php $__env->startPush('crud_fields_styles'); ?>
        <link href="<?php echo e(asset('packages/cropperjs/dist/cropper.min.css')); ?>" rel="stylesheet" type="text/css" />
        <style>
            .image .btn-group {
                margin-top: 10px;
            }
    ...
    <?php $__env->startPush('crud_fields_scripts'); ?>
        <script src="<?php echo e(asset('packages/cropperjs/dist/cropper.min.js')); ?>"></script>
        <script src="<?php echo e(asset('packages/jquery-cropper/dist/jquery-cropper.min.js')); ?>"></script>
        <script>
            function bpFieldInitCropperImageElement(element) {
                    ...
                    $uploadImage.change(function() {
                        ...
                        const maxImageSize = <?php echo e($max_image_size_in_bytes); ?>;
...
<?php /**PATH E:\Programs\OpenServer\OSPanel\domains\storeclothing\vendor\backpack\crud\src\resources\views\crud/fields/image.blade.php ENDPATH**/ ?>