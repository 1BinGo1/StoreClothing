            ...
            <div class="modal-body">
                <form action="" method="post" novalidate enctype="multipart/form-data" id="form-create-brand">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="brand-name" placeholder="Name" value="<?php echo e(old('name') ?? ''); ?>">
                    </div>
                    <div class="form-group">
...
<?php /**PATH E:\Programs\OpenServer\OSPanel\domains\storeclothing\resources\views/admin/create_brand.blade.php ENDPATH**/ ?>