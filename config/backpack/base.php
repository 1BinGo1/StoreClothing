...
return [
    ...
    */
    ...
    'project_logo'   => '<label style="color: white"><b>Back</b>pack</label>',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => true,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    'header_class' => 'app-header bg-primary border-0 navbar',
    ...
    'sidebar_class' => 'sidebar sidebar-pills bg-primary',
    ...
    'footer_class' => 'app-footer d-print-none bg-primary',
    // hide it with d-none
    // change background color with bg-dark, bg-primary, bg-secondary, bg-danger, bg-warning, bg-success, bg-info, bg-blue, bg-light-blue, bg-indigo, bg-purple, bg-pink, bg-red, bg-orange, bg-yellow, bg-green, bg-teal, bg-cyan, bg-white

    // Developer or company name. Shown in footer.
    'developer_name' => 'Silantiev Aleksey',
